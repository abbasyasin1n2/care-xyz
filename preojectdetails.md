...
3. Booking Page (/booking/:service_id) – Private Route
   ...
   · Steps for booking:
4. Select Duration (days/hours)
5. Select Location: Division, District, City, Area / Address
6. Show Total Cost dynamically
7. Confirm Booking → Booking saved with status = Pending
8. Authentication
...
9. My Booking Page (/my-bookings) – Private Route
